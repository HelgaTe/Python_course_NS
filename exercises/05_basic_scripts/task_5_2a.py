...
'''
'00001010000000000000010111000011' - ориентировочно получим такое значение,
это поможет нам определить адрес хоста или адрес сети 
адрес  cети - все биты хостовой части равны нулю
'''
bin_network_str = bin_ip_str[:mask] + "0" * (32 - mask) # Заменить быти хвостовой части на ноли
