...
Скопируйте скрипт add_data_status.py из задания 25.1 и попробуйте выполнить его
...
Измените скрипт add_data_status.py таким образом, чтобы выполнялись новые условия
